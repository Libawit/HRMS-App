...
const SideBar = ({ isCollapsed, theme, user }) => {
  ...
  const menuItems = [
    ...
    { 
      ...
      icon: <Users size={18}/>, 
      subItems: [
        { name: 'Employee Directory', path: '/manager/employee' },
        { name: 'Employee History', path: '/manager/employee-history' }
      ]
    },
    { 
      name: 'Organization', 
      icon: <Layers size={18}/>, 
      subItems: [
        { name: 'Department', path: '/manager/department' },
        { name: 'Job Position', path: '/manager/job-position' },
        { name: 'Structure', path: '/manager/structure' }
      ]
    },
    { 
      name: 'Leave', 
      ...
      subItems: [
        { name: 'Leave Type', path: '/manager/leave-type' },
        { name: 'Leave Balance', path: '/manager/leave-balance' },
        { name: 'Leave Request', path: '/manager/leave-request' },
    ...
    { 
      ...
      subItems: [
        { name: 'Attendance Records', path: '/manager/attendance-record' },
        { name: 'Time Tracking', path: '/manager/time-tracking' }
      ]
    },
    { name: 'Documents', icon: <FileText size={18}/>, path: '/manager/documents' },
    { name: 'Salary', icon: <Banknote size={18}/>, path: '/manager/salary' },
    { name: 'Profile', icon: <UserCircle size={18}/>, path: '/manager/profile' },
  ];
