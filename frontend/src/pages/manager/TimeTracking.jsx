...
const TimeTracking = () => {
  ...
  // FIXED QR VALUE: Station ID for office entrance verification
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-6">
          <div className={`${styles.bgCard} border ${styles.border} rounded-3xl p-8 relative overflow-hidden shadow-xl`}>
            ...
            {/* Stats Row */}
            <div className={`grid grid-cols-2 md:grid-cols-3 gap-4 mt-12 pt-8 border-t ${styles.border}`}>
          ...
          <div className={`${styles.bgCard} border ${styles.border} rounded-3xl p-6`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className={`p-5 rounded-2xl ${styles.inputBg} space-y-2`}>
        ...
        <div className="space-y-6">
          <div className={`${styles.bgCard} border ${styles.border} rounded-3xl p-8 flex flex-col items-center text-center shadow-lg`}>
            ...
            <button className={`flex items-center gap-2 px-5 py-2.5 rounded-xl border ${styles.border} ${styles.textMain} hover:bg-white/5 transition-all text-[10px] font-black uppercase tracking-widest`}>
              <Printer size={16} /> Print Station Code
            </button>
          </div>
