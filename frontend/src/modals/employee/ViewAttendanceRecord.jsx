...
const ViewAttendanceRecord = ({ isOpen, onClose, theme = 'dark', data }) => {
  ...
  // Mapping Prisma field names (notes) to component display
  const displayNote = data.notes || data.note || "No additional notes provided for this record.";
  ...
  const getStatusColor = (status) => {
    switch(status) {
      ...
      case 'Half Day': return 'text-blue-500 bg-blue-500/10 border-blue-500/20';
  ...
  return (
    <div className={styles.modalOverlay} onClick={onClose}>
      <div 
        className={`w-full max-w-2xl rounded-3xl border ${styles.card} overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200`}
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[70vh] overflow-y-auto">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className={styles.value}>{data.checkInTime || data.checkIn || '--:--'}</div>
                    </div>
                  </div>
                  ...
                  <div className="text-right">
                    <div className="flex items-center gap-3 justify-end">
                      <div>
                        ...
                        <div className={styles.value}>{data.checkOutTime || data.checkOut || '--:--'}</div>
                      </div>
          ...
          <div className={`p-4 rounded-2xl border ${styles.infoBox} flex flex-col`}>
             <div className="flex items-center gap-2 text-[#7c3aed] mb-6 font-bold text-xs uppercase tracking-tighter">
              ...
              <div className="flex-1 space-y-8 relative before:content-[''] before:absolute before:left-3.75 before:top-2 before:bottom-2 before:w-0.5 before:bg-[#7c3aed]/10">
                <div className="relative pl-10">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-[#94a3b8]">Entry recorded at {data.checkInTime || data.checkIn || '--:--'}</div>
                  </div>
                </div>
                ...
                <div className="relative pl-10">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-[#94a3b8]">Exit recorded at {data.checkOutTime || data.checkOut || '--:--'}</div>
                  </div>
                </div>
              </div>
          </div>
